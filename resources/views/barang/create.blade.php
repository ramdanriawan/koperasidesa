                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('admin.barang.store') }}" enctype='multipart/form-data'>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="harga" type="number" min='1000' max='10000000' class="barangHarga form-control{{ $errors->has('harga') ? ' is-invalid' : '' }}" name="harga" value="{{ old('harga') }}" required autofocus>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="jumlah" type="number" min='1' max='1000' class="barangJumlah form-control{{ $errors->has('jumlah') ? ' is-invalid' : '' }}" name="jumlah" value="{{ old('jumlah') }}" required autofocus>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="total" type="number" min='1000' max='10000000' class="barangTotal form-control{{ $errors->has('total') ? ' is-invalid' : '' }}" name="total" value="{{ old('total') }}" required autofocus disabled>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="gambar" type="file" class="form-control{{ $errors->has('gambar') ? ' is-invalid' : '' }}" name="gambar" required autofocus>
