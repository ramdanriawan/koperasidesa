    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('admin.pengeluaran.update', ['pengeluaran' => $data->id]) }}">
                        @csrf
                        @method('put')
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <select id="anggota_id" type="text" class="pengeluaranAnggota form-control{{ $errors->has('anggota_id') ? ' is-invalid' : '' }}" name="anggota_id">
                                    ...
                                    <option value='{{ $id }}' {{ $id == $data->anggota_id ? "selected": "" }}>{{ $nama }}</option>
                                    @endforeach
                                </select>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="harga" type="number" class="pengeluaranHarga form-control{{ $errors->has('harga') ? ' is-invalid' : '' }}" name="harga" value="{{ $data->harga }}" required autofocus>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="jumlah" type="text" class="pengeluaranJumlah form-control{{ $errors->has('jumlah') ? ' is-invalid' : '' }}" name="jumlah" value="{{ $data->jumlah }}" required autofocus>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="total" type="text" class="pengeluaranTotal form-control{{ $errors->has('total') ? ' is-invalid' : '' }}" name="total" value="{{ $data->total }}" required autofocus>
